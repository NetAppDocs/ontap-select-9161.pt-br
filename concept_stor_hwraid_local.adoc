...
NOTE: A sobrecarga do VMFS é diferente de zero (VMware KB 1001618), e a tentativa de usar todo o espaço relatado como livre por um datastore resultou em erros espúrios durante as operações de criação de cluster.
